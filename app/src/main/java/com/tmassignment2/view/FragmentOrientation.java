...
public class FragmentOrientation extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.view_orientation, container, false);
    ...
    public void initView() {
        if (((MainActivity) getActivity()) != null) {
            ...
            id.setText(String.valueOf(infoList.get(currentItem).orientations.getId()));
            name.setText(infoList.get(currentItem).orientations.getName());
        }
